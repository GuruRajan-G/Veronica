...
var detailId;
var interval;
var EFconnectionString="LOUSISWTS110";
...
function GeExecutables(id) {
    var data = App.GetApiData("/GetExecutables", { executionId: id, servername: EFconnectionString });
    if (!executablesTable) {
...
function GetMessages(id, type) {
    var data = App.GetApiData("/GetMessages", { executionId: id, type: type, servername: EFconnectionString });
    if (!messagesTable) {
...
function UpdateProjectList(control) {
    var data = App.GetApiData("/GetExecutions", { servername: EFconnectionString });
...
function UpdateKPI() {
    //alert("Here");
    var data = App.GetApiData("/GetKPI", { servername: EFconnectionString })
    if (data) {
        //reset all to 0
        $('.statusCount').html(0);
